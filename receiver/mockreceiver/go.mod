module github.com/open-telemetry/opentelemetry-collector-contrib/receiver/mockreceiver

go 1.21.1

replace github.com/open-telemetry/opentelemetry-collector-contrib/receiver/mockreceiver => ./
